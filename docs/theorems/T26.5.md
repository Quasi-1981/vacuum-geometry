# Period P=d+1 plus dual column equals the circle 2π/(d+1) (Pontryagin); 1A+1B+(d-1) holes
...
Establishes the period P=d+1 and shows the dual column corresponds to the circle of circumference 2π/(d+1) via Pontryagin duality, with structure 1A+1B+(d-1) holes.
