...
**Consumed by:** [Dihedral hinge D_h=⟨c,w₀⟩ of the −2↔−1 joint](OBJ-Dh.md) · [The arrow is a single bit of realization (5 legs + wedge witness ver:2): no A/B discriminator exists](T36.md) · [w_0 is identified with k <-> -k, identified with the epsilon-flip](id-2.2.md) · [Arrow/class-count (T28+T36 from W41): Coxeter action c leads to epsilon -> -epsilon, 1 bit, D_h orbit](shov.6.md)
